  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Pi-based settlement and transaction services"
        />
      </Head>
          ...
          <div className="space-y-6">
            <div className="bg-gray-800 p-6 rounded-lg border border-[#00ff9d]/20">
              <h3 className="text-2xl font-bold text-[#00ff9d] mb-3">
                Instant Settlement / التسوية الفورية
              </h3>
              <p className="text-gray-400">
                Real-time Pi transaction processing
              </p>
            </div>

            <div className="bg-gray-800 p-6 rounded-lg border border-[#00c6ff]/20">
              <h3 className="text-2xl font-bold text-[#00c6ff] mb-3">
                Bulk Transactions / المعاملات الجماعية
              </h3>
              <p className="text-gray-400">
            ...
            <div className="bg-gray-800 p-6 rounded-lg border border-[#00ff9d]/20">
              <h3 className="text-2xl font-bold text-[#00ff9d] mb-3">
                International Settlements / التسويات الدولية
              </h3>
              <p className="text-gray-400">
                Cross-border Pi transactions made simple
              </p>
            </div>
          </div>
        </div>
