  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Comprehensive market intelligence reports"
        />
      </Head>
          ...
          <div className="space-y-6">
            <div className="bg-gray-800 p-6 rounded-lg border border-[#00ff9d]/20">
              ...
              <p className="text-gray-400">
                Daily market intelligence and insights
              </p>
            </div>

            <div className="bg-gray-800 p-6 rounded-lg border border-[#00c6ff]/20">
              <h3 className="text-2xl font-bold text-[#00c6ff] mb-3">
                Weekly Analysis / التحليل الأسبوعي
              </h3>
              <p className="text-gray-400">
                Comprehensive weekly market reviews
              </p>
            </div>

            <div className="bg-gray-800 p-6 rounded-lg border border-[#00ff9d]/20">
              <h3 className="text-2xl font-bold text-[#00ff9d] mb-3">
                Monthly Outlook / التوقعات الشهرية
              </h3>
              <p className="text-gray-400">
                Strategic monthly market forecasts
              </p>
            </div>
          </div>
        </div>
