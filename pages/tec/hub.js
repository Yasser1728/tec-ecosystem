  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Central hub for all TEC sovereign business services"
        />
      </Head>
      ...
      <main className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900">
        <div className="container mx-auto px-4 py-16">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Your Gateway to 24 Elite Business Services / بوابتك إلى 24 خدمة
            أعمال نخبوية
          </p>
          ...
          <div className="grid md:grid-cols-4 gap-6">
            ...
            <div className="bg-gray-800 p-6 rounded-lg border border-[#00c6ff]/20">
              <h3 className="text-xl font-bold text-[#00c6ff] mb-2">
                Commerce & Trade
              </h3>
          ...
          <div className="mt-8 bg-gray-800 p-8 rounded-lg border border-[#00ff9d]/20">
            <h3 className="text-3xl font-bold text-[#00c6ff] mb-4">
              Unified Access
            </h3>
            <p className="text-gray-300 mb-4">
              TEC Hub provides seamless access to all 24 sovereign business
              domains from a single, unified interface. Navigate the entire
              ecosystem with ease.
            </p>
