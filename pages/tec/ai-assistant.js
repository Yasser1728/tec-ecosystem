        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="mb-8">
            ...
            <div className="bg-gradient-to-r from-[#00ff9d]/10 to-[#00c6ff]/10 border border-[#00ff9d]/20 rounded-lg p-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h3 className="text-white font-semibold mb-1">About the TEC Assistant</h3>
                  <p className="text-gray-300 text-sm">
                    I'm your AI-powered guide to the TEC ecosystem. Ask me about any of our 24 domains, 
                    payment methods, subscription tiers, or how to get started. I'm here to help you 
                    discover and navigate all that TEC has to offer!
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-800 rounded-lg border border-[#00ff9d]/20 p-6">
                <h3 className="text-xl font-bold text-[#00ff9d] mb-4">Quick Actions</h3>
                <div className="space-y-3">
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      <span className="text-2xl">🌐</span>
                      <div>
                        <p className="text-white font-semibold">Explore Domains</p>
                        <p className="text-xs text-gray-400">View all 24 domains</p>
                      </div>
                    </div>
                  </Link>
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      <span className="text-2xl">📊</span>
                      <div>
                        <p className="text-white font-semibold">View Overview</p>
                        <p className="text-xs text-gray-400">Ecosystem insights</p>
                      </div>
                    </div>
                  </Link>
                </div>
              ...
              <div className="bg-gray-800 rounded-lg border border-[#00c6ff]/20 p-6">
                <h3 className="text-xl font-bold text-[#00c6ff] mb-4">Popular Topics</h3>
              ...
              {/* Support */}
              <div className="bg-gray-800 rounded-lg border border-[#00ff9d]/20 p-6">
                <h3 className="text-xl font-bold text-[#00ff9d] mb-4">Need Help?</h3>
          ...
          <div className="mt-8 p-4 bg-blue-500/10 border border-blue-500/30 rounded-lg">
            <p className="text-sm text-blue-300 text-center">
              ℹ️ Currently using mock responses. Full AI integration with OpenAI/custom models coming soon.
            </p>
          </div>
        </div>
      </main>
