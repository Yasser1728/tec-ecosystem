        ...
        <div className="container mx-auto px-4 py-16">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-gray-800 p-6 rounded-lg border border-[#00ff9d]/20">
              <h3 className="text-2xl font-bold text-[#00ff9d] mb-3">Joint Ventures / المشاريع المشتركة</h3>
              <p className="text-gray-400">Collaborate on strategic projects</p>
            </div>
            
            <div className="bg-gray-800 p-6 rounded-lg border border-[#00c6ff]/20">
              <h3 className="text-2xl font-bold text-[#00c6ff] mb-3">Partnership Agreements / اتفاقيات الشراكة</h3>
              <p className="text-gray-400">Secure partnerships with legal frameworks</p>
            </div>
          </div>
        </div>
      </main>
