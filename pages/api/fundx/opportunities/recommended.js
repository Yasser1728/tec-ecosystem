...
export default async function handler(req, res) {
  ...
  try {
    ...
    await quickStartService.updateStep(
      userId,
      QUICK_START_STEPS.INVESTMENT_OPPORTUNITY,
      {
        viewed: true,
        riskProfile,
      },
    ...
    const opportunities = [
      {
        ...
        description:
          "Diversified portfolio with 60% stocks, 30% crypto, 10% bonds for steady growth with moderate risk",
        riskLevel: "MODERATE",
        minInvestment: 1000,
        currentNAV: 125.5,
        targetReturn: 15.5,
        ...
        recommended: true,
        reason:
          "Matches your moderate risk profile and provides balanced exposure to growth assets",
        benefits: [
      ...
      },
      {
        ...
        description:
          "Low-risk portfolio focused on stable income with 70% bonds, 20% dividend stocks, 10% cash",
        ...
        reason:
          "Lower risk option with steady income generation for conservative investors",
        benefits: [
      ...
      },
      {
        ...
        description:
          "High-risk, high-reward portfolio with 50% crypto, 40% growth stocks, 10% emerging markets",
        ...
        reason:
          "Maximum growth potential for aggressive investors comfortable with high volatility",
        benefits: [
    ...
    const filtered = opportunities.sort(
