...
export default async function handler(req, res) {
  try {
    ...
    if (req.method === 'POST') {
      ...
      await quickStartService.updateStep(userId, QUICK_START_STEPS.ASSET_ADDITION, {
        assetId: asset.id,
        assetName: name,
      ...
      if (insuranceTriggered) {
        ...
        await quickStartService.updateStep(userId, QUICK_START_STEPS.INSURANCE_RECOMMENDATION, {
          assetId: asset.id,
          assetValue: currentValue,
