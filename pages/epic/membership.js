  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Explore Epic membership tiers and benefits" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-gray-800 p-6 rounded-lg border border-[#00ff9d]/20">
              <h3 className="text-2xl font-bold text-[#00ff9d] mb-3">Epic Bronze / البرونز الملحمي</h3>
            ...
            <div className="bg-gray-800 p-6 rounded-lg border border-[#00c6ff]/20">
              <h3 className="text-2xl font-bold text-[#00c6ff] mb-3">Epic Silver / الفضة الملحمية</h3>
            ...
            <div className="bg-gray-800 p-6 rounded-lg border border-[#00ff9d]/20">
              <h3 className="text-2xl font-bold text-[#00ff9d] mb-3">Epic Gold / الذهب الملحمي</h3>
