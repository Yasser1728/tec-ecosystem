  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Educational resources for wealth building"
        />
      </Head>
      ...
      <main className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900">
        <div className="container mx-auto px-4 py-16">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Educational Resources for Legacy Building / موارد تعليمية لبناء
            الإرث
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-gray-800 p-6 rounded-lg border border-[#00ff9d]/20">
              <h3 className="text-2xl font-bold text-[#00ff9d] mb-3">
                Video Courses / دورات فيديو
              </h3>
              <p className="text-gray-400">
                Expert-led wealth management courses
              </p>
            </div>

            <div className="bg-gray-800 p-6 rounded-lg border border-[#00c6ff]/20">
              <h3 className="text-2xl font-bold text-[#00c6ff] mb-3">
                eBooks & Guides / كتب إلكترونية وأدلة
              </h3>
              <p className="text-gray-400">
