      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white">
        ...
        <main className="container mx-auto px-4 py-12">
          ...
          <div className="bg-gray-800 border border-gray-700 rounded-xl p-8 mb-8">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <span className="font-mono text-[#00ff9d]">{hostname || 'Loading...'}</span>
              </div>
              ...
              {domainInfo ? (
                <>
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-mono text-[#00ff9d]">{domainInfo.domain}</span>
                  </div>
                  <div className="flex items-center gap-3">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-green-400">✓ {domainInfo.status}</span>
                  </div>
                </>
              ) : (
          ...
          <div className="bg-gray-800 border border-gray-700 rounded-xl p-8">
            <h2 className="text-2xl font-bold mb-4">All Configured Domains ({Object.keys(domainMapping).length})</h2>
              ...
              {Object.entries(domainMapping).map(([domain, config]) => (
                ...
                >
                  <div className="flex items-center justify-between mb-2">
                    <span className="font-mono text-sm text-[#00ff9d]">{domain}</span>
                    {hostname === domain && (
          ...
          <div className="bg-blue-500/10 border border-blue-500/50 rounded-xl p-8 mt-8">
            ...
            <div className="space-y-4 text-gray-300">
              <div>
                ...
                <p>Visit: <code className="bg-gray-900 px-2 py-1 rounded">http://localhost:3000/test-domain</code></p>
                <p className="text-sm text-gray-400 mt-1">Will show development URL (not .pi domain)</p>
              </div>
              
              <div>
                <h3 className="font-bold text-white mb-2">Production Testing:</h3>
                <ol className="list-decimal list-inside space-y-2 text-sm">
                  <li>Deploy to Vercel</li>
                  <li>Configure domains in Pi Developer Portal</li>
                  <li>Open Pi Browser</li>
                  <li>Visit: <code className="bg-gray-900 px-2 py-1 rounded">life.pi/test-domain</code></li>
