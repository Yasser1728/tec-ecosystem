      ...
      <main className="min-h-screen bg-gray-900 text-white py-12">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <section className="bg-gray-800 border border-[#00ff9d]/30 rounded-lg p-6 mb-8">
            <h2 className="text-2xl font-bold text-[#00ff9d] mb-4">⚡ Quick Start</h2>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    Visit <a href="https://developers.minepi.com" target="_blank" rel="noopener" className="text-[#00c6ff] hover:underline">Pi Developer Portal</a> and create new app
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">Copy your App ID from the dashboard</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">Add NEXT_PUBLIC_PI_APP_ID in Vercel environment variables</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">Set NEXT_PUBLIC_PI_SANDBOX=true for testing</p>
                </div>
              </div>
            </div>
          </section>
          ...
          {/* App Configuration */}
          <section className="bg-gray-800 border border-[#00ff9d]/30 rounded-lg p-6 mb-8">
            <h2 className="text-2xl font-bold text-[#00ff9d] mb-4">📱 App Configuration</h2>
          ...
          {/* Testing */}
          <section className="bg-gray-800 border border-[#00ff9d]/30 rounded-lg p-6 mb-8">
            <h2 className="text-2xl font-bold text-[#00ff9d] mb-4">🧪 Testing</h2>
            <div className="space-y-4">
              <div>
          ...
          {/* Troubleshooting */}
          <section className="bg-gray-800 border border-[#00ff9d]/30 rounded-lg p-6 mb-8">
            <h2 className="text-2xl font-bold text-[#00ff9d] mb-4">🔍 Troubleshooting</h2>
            <div className="space-y-3 text-sm">
              <div>
                <h3 className="font-bold text-red-400 mb-1">❌ "Pi SDK not loaded"</h3>
                <p className="text-gray-400">Check browser console, refresh page, or enable sandbox mode</p>
              </div>
              <div>
                <h3 className="font-bold text-red-400 mb-1">❌ "Invalid App ID"</h3>
                <p className="text-gray-400">Verify App ID in Vercel environment variables and redeploy</p>
              </div>
              <div>
                <h3 className="font-bold text-red-400 mb-1">❌ "Payment not working"</h3>
                <p className="text-gray-400">Ensure sandbox mode is enabled and check payment callbacks</p>
              </div>
            </div>
          </section>
          ...
          {/* Links */}
          <section className="bg-gray-800 border border-[#00ff9d]/30 rounded-lg p-6 mb-8">
            <h2 className="text-2xl font-bold text-[#00ff9d] mb-4">🔗 Useful Links</h2>
            <div className="space-y-2 text-sm">
              <a href="https://developers.minepi.com" target="_blank" rel="noopener" className="block text-[#00c6ff] hover:underline">
                → Pi Developer Portal
              </a>
              <a href="https://developers.minepi.com/doc/javascript-sdk" target="_blank" rel="noopener" className="block text-[#00c6ff] hover:underline">
                → Pi SDK Documentation
              </a>
              <a href="https://minepi.com" target="_blank" rel="noopener" className="block text-[#00c6ff] hover:underline">
                → Pi Network
              </a>
          ...
          <div className="text-center">
            <Link href="/" className="inline-block bg-gradient-to-r from-[#00ff9d] to-[#00c6ff] text-gray-900 px-8 py-3 rounded-lg font-semibold hover:shadow-lg transition-all duration-300">
