  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Comprehensive portfolio management dashboard" />
      </Head>
        ...
        <div className="container mx-auto px-4 py-16">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            <div className="bg-gray-800 p-6 rounded-lg border border-[#00ff9d]/20">
              <h3 className="text-lg text-gray-400 mb-2">Total Value / القيمة الإجمالية</h3>
              <p className="text-3xl font-bold text-[#00ff9d]">2.5M Pi</p>
            </div>
            
            <div className="bg-gray-800 p-6 rounded-lg border border-[#00c6ff]/20">
              <h3 className="text-lg text-gray-400 mb-2">YTD Return / العائد السنوي</h3>
              <p className="text-3xl font-bold text-[#00c6ff]">+24.3%</p>
            </div>
            
            <div className="bg-gray-800 p-6 rounded-lg border border-[#00ff9d]/20">
              <h3 className="text-lg text-gray-400 mb-2">Assets Count / عدد الأصول</h3>
              <p className="text-3xl font-bold text-[#00ff9d]">18</p>
            </div>
          </div>

          <div className="bg-gray-800 p-6 rounded-lg border border-[#00c6ff]/20">
            <h3 className="text-2xl font-bold text-[#00c6ff] mb-4">Asset Allocation / توزيع الأصول</h3>
            <div className="space-y-3">
              <div>
                ...
                <div className="w-full bg-gray-900 rounded h-2">
                  <div className="bg-[#00ff9d] h-2 rounded" style={{width: '40%'}}></div>
                </div>
              </div>
              <div>
                <div className="flex justify-between mb-1">
                ...
                <div className="w-full bg-gray-900 rounded h-2">
                  <div className="bg-[#00c6ff] h-2 rounded" style={{width: '30%'}}></div>
                </div>
              </div>
              <div>
                <div className="flex justify-between mb-1">
                ...
                <div className="w-full bg-gray-900 rounded h-2">
                  <div className="bg-[#00ff9d] h-2 rounded" style={{width: '20%'}}></div>
                </div>
              </div>
              <div>
                <div className="flex justify-between mb-1">
                ...
                <div className="w-full bg-gray-900 rounded h-2">
                  <div className="bg-[#00c6ff] h-2 rounded" style={{width: '10%'}}></div>
                </div>
              </div>
            </div>
          </div>
