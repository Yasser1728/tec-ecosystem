      ...
      <main className="min-h-screen bg-gray-900 text-white py-12">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="mb-8 text-sm text-gray-400">
            <Link href="/" className="hover:text-[#00ff9d]">TEC</Link>
            {' > '}
            <Link href="/estate" className="hover:text-[#00ff9d]">Estate</Link>
            {' > '}
          ...
          <div className="mb-12">
            ...
            <p className="text-xl text-gray-300">
              Your complete guide to purchasing luxury real estate using Pi Network
            </p>
          </div>

          {/* Introduction */}
          <div className="bg-gray-800 border border-[#00ff9d]/30 rounded-lg p-8 mb-8">
            <h2 className="text-2xl font-bold mb-4 text-[#00ff9d]">Why Buy Real Estate with Pi?</h2>
            <div className="space-y-4 text-gray-300">
              <p>
                Pi Network enables sovereign settlements for luxury real estate transactions, 
                offering a secure, transparent, and efficient way to invest in property worldwide.
              </p>
          ...
          {/* 4 Steps Process */}
          <div className="mb-12">
            <h2 className="text-3xl font-bold mb-8 text-center">The 4-Step Legal Process</h2>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-800 border-l-4 border-[#00ff9d] rounded-lg p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold mb-3 text-[#00ff9d]">Property Selection & Verification</h3>
                    <p className="text-gray-300 mb-4">
                      Browse curated luxury properties. Each listing is verified by our expert team 
              ...
              <div className="bg-gray-800 border-l-4 border-[#00c6ff] rounded-lg p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold mb-3 text-[#00c6ff]">Consultation & Deal Structuring</h3>
                    <p className="text-gray-300 mb-4">
                      Work with dedicated advisors to structure the perfect deal customized to your goals.
                    </p>
                    <ul className="space-y-2 text-gray-400">
                      <li className="flex items-start gap-2">
              ...
              <div className="bg-gray-800 border-l-4 border-purple-500 rounded-lg p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold mb-3 text-purple-400">Pi Settlement & Smart Contracts</h3>
                    <p className="text-gray-300 mb-4">
                      Execute transactions using Pi Network's secure blockchain. Smart contracts ensure transparency.
                    </p>
                    <ul className="space-y-2 text-gray-400">
                      <li className="flex items-start gap-2">
              ...
              <div className="bg-gray-800 border-l-4 border-yellow-500 rounded-lg p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold mb-3 text-yellow-400">Ownership Transfer & Support</h3>
                    <p className="text-gray-300 mb-4">
                      Complete legal transfer with full support. We handle all paperwork and ensure smooth handover.
                    </p>
                    <ul className="space-y-2 text-gray-400">
                      <li className="flex items-start gap-2">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-4">
            <Link href="/estate/countries" className="bg-gray-800 border border-gray-700 hover:border-[#00ff9d] rounded-lg p-4 transition-all">
              <div className="text-2xl mb-2">🌍</div>
              <h3 className="font-bold mb-1">Countries Guide</h3>
              <p className="text-sm text-gray-400">Countries accepting Pi</p>
            </Link>
            <Link href="/estate/listings" className="bg-gray-800 border border-gray-700 hover:border-[#00ff9d] rounded-lg p-4 transition-all">
              <div className="text-2xl mb-2">🏠</div>
              <h3 className="font-bold mb-1">Featured Properties</h3>
              <p className="text-sm text-gray-400">Browse elite listings</p>
            </Link>
            <Link href="/insure" className="bg-gray-800 border border-gray-700 hover:border-[#00ff9d] rounded-lg p-4 transition-all">
