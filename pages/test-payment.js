...
export default function TestPayment() {
  ...
  const handleIncompletePayment = async (payment) => {
    ...
    try {
      // Sync incomplete payment with server
      ...
      if (data.success) {
        ...
        setPaymentStatus(`⚠️ Incomplete payment sync issue: ${data.error || "Unknown error"}`);
      }
    } catch (err) {
          ...
          onReadyForServerCompletion: (paymentId, txid) => {
            ...
            fetch("/api/payments/complete", {
              ...
              .then((data) => {
                ...
                setPaymentStatus(
                  `🎉 Payment fully completed! Check Pi Developer Portal now.`,
                );
                setLoading(false);
              })
              .catch((err) => {
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Test Pi Network payment for Developer Portal Step 6"
        />
      </Head>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl border border-purple-500/30 p-8 shadow-2xl">
            ...
            <div className="bg-blue-500/20 border border-blue-400/30 rounded-lg p-6 mb-8">
              ...
              <ol className="list-decimal list-inside space-y-2 text-blue-100">
                <li>
                  Make sure you're in <strong>Pi Browser</strong>
                </li>
                <li>Click the "Test Payment" button below</li>
                <li>
                  Complete the payment in the Pi popup (Sandbox mode - no real
                  Pi)
                </li>
                <li>Wait for confirmation</li>
                <li>
                  Go back to <strong>Pi Developer Portal</strong>
                </li>
                <li>
                  Check if <strong>Step 6</strong> is now marked as complete ✅
                </li>
              </ol>
            </div>
            ...
            <div className="mt-8 space-y-4 text-gray-300">
              <div className="bg-purple-500/20 border border-purple-400/30 rounded-lg p-4">
                ...
                <ul className="list-disc list-inside space-y-1 text-sm">
                  <li>
                    This is a <strong>Sandbox payment</strong> - no real Pi will
                    be charged
                  </li>
                  <li>Amount: 1 Pi (test amount)</li>
                  <li>Purpose: Complete Step 6 in Pi Developer Portal</li>
                  <li>
                    The payment will be processed through Pi Network's test
                    environment
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-yellow-500/20 border border-yellow-400/30 rounded-lg p-4">
                ...
                <ul className="list-disc list-inside space-y-1 text-sm">
                  ...
                  <li>
                    Make sure you're using <strong>Pi Browser</strong>
                  </li>
                  <li>
                    Check that Sandbox mode is enabled in Pi Developer Portal
                  </li>
                  <li>
                    If Step 6 doesn't activate, wait 5-10 minutes and refresh
                  </li>
