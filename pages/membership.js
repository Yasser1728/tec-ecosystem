  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Choose your TEC membership tier and unlock exclusive benefits"
        />
      </Head>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Choose the membership level that matches your ambitions. Each tier
              unlocks exclusive benefits and priority access to elite
              opportunities.
            </p>
          </div>
              ...
              <table className="w-full text-left">
                ...
                <tbody className="text-sm">
                  <tr className="border-b border-gray-700">
                    ...
                    <td className="py-4 px-4 text-center text-[#00ff9d]">
                      Immediate
                    </td>
                  </tr>
                  <tr className="border-b border-gray-700">
            ...
            <div className="space-y-4">
              <div className="bg-gray-800 border border-gray-700 rounded-lg p-6">
                ...
                <p className="text-gray-400 text-sm">
                  Yes, you can change your membership tier at any time. Upgrades
                  take effect immediately, while downgrades take effect at the
              ...
              <div className="bg-gray-800 border border-gray-700 rounded-lg p-6">
                ...
                <p className="text-gray-400 text-sm">
                  We accept Pi Network cryptocurrency for all membership
                  payments. Payments are processed securely through Pi's
              ...
              <div className="bg-gray-800 border border-gray-700 rounded-lg p-6">
                ...
                <p className="text-gray-400 text-sm">
                  No long-term contracts required. All memberships are
                  month-to-month and can be cancelled at any time with no
                  penalties.
                </p>
              </div>
              ...
              <div className="bg-gray-800 border border-gray-700 rounded-lg p-6">
                ...
                <p className="text-gray-400 text-sm">
                  You'll retain access to your membership benefits until the end
                  of your current billing period. After that, you'll revert to
                  Bronze (free) tier access.
                </p>
              </div>
            </div>
          </div>
