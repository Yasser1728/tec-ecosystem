...
export class ConfirmDailyCheckIn {
  ...
  async execute(input: ConfirmDailyCheckInInput): Promise<ConfirmDailyCheckInOutput> {
    ...
    const newStreak = this.calculateStreak(latestCheckIn?.date, today, user.currentStreak);
