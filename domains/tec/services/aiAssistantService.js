...
class AiAssistantService {
  ...
  async generateResponse(message, context) {
    ...
    if (lowerMessage.includes("domain") || lowerMessage.includes("domains")) {
      return {
        content:
          "The TEC Ecosystem consists of 24 sovereign business domains across financial services, premium services, commerce, and technology. Each domain operates independently while being seamlessly integrated. Would you like to explore a specific domain category?",
        suggestions: [
          "Financial Services",
          "Premium Services",
          "Commerce Domains",
    ...
    if (lowerMessage.includes("estate") || lowerMessage.includes("property")) {
      return {
        content:
          "TEC Estate is our premium real estate marketplace offering villas, apartments, commercial properties, and land. You can browse properties, schedule viewings, and complete transactions using Pi Network payments.",
        suggestions: ["Browse Properties", "How to Buy", "Seller Information"],
        links: [{ text: "Visit TEC Estate", url: "/estate" }],
      };
    }
    ...
    if (
      ...
      return {
        content:
          "All TEC ecosystem transactions are powered by Pi Network. You can pay for services, products, and subscriptions using Pi cryptocurrency. Your Pi wallet is integrated across all domains for seamless transactions.",
        suggestions: [
          "Payment Methods",
          "Transaction History",
          "Wallet Balance",
        ],
        links: [{ text: "View Payment Info", url: "/payments" }],
      };
    }
    ...
    if (
      ...
      return {
        content:
          "I'm here to help you navigate the TEC ecosystem! You can ask me about any of our 24 domains, how to make payments, subscription tiers, or general ecosystem features. What would you like to know more about?",
        suggestions: [
          "Getting Started",
          "Available Services",
          "Subscription Tiers",
    ...
    if (
      ...
      return {
        content:
          "TEC offers multiple subscription tiers: GUEST (free, limited access), STANDARD (basic features), PREMIUM (full access), and ADMIN (complete control). Each tier unlocks different features across our 24 domains. Would you like to learn about upgrading?",
        suggestions: ["Compare Tiers", "Upgrade Now", "Tier Benefits"],
        links: [{ text: "View Pricing", url: "/upgrade" }],
      };
    }
    ...
    if (
      ...
      return {
        content:
          "I'm the TEC Assistant, your intelligent guide to the entire TEC ecosystem. I can help you discover domains, understand features, complete transactions, and navigate our services. I'm powered by advanced AI to provide personalized assistance.",
        suggestions: [
          "Your Capabilities",
          "Example Questions",
          "Privacy Policy",
