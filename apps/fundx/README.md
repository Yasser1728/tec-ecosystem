...
📊 **FundX** - Sovereign investment strategies powered by Pi Network

## 🏢 Domain Identity

- **Name**: FundX
- **Display Name**: FundX.pi
- **Domain Key**: fundx
- **Icon**: 📊
...
- **Database**: `fundx_db` (isolated schema)
...
- `FUNDX_DB_SCHEMA`: Database schema name
