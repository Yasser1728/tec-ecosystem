...
🛡️ **Insure** - Comprehensive insurance for your investments and assets

## 🏢 Domain Identity

- **Name**: Insure
- **Display Name**: Insure.pi
- **Domain Key**: insure
- **Icon**: 🛡️
...
Asset protection, deal insurance, and claim management
...
- **Database**: `insure_db` (isolated schema)
...
- `INSURE_DB_SCHEMA`: Database schema name
...
```javascript
import { InsureDomain } from './apps/insure';

// Initialize domain with sovereign controls
const domain = new InsureDomain();
