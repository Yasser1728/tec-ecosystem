...
✈️ **Explorer** - Exclusive travel experiences and residency programs

## 🏢 Domain Identity

- **Name**: Explorer
- **Display Name**: Explorer.pi
- **Domain Key**: explorer
- **Icon**: ✈️
...
Private jet charter, residency programs, and luxury travel packages
...
- **Database**: `explorer_db` (isolated schema)
...
- `EXPLORER_DB_SCHEMA`: Database schema name
...
```javascript
import { ExplorerDomain } from './apps/explorer';

// Initialize domain with sovereign controls
const domain = new ExplorerDomain();
