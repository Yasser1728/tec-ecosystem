...
🛒 **Ecommerce** - Access rare luxury goods and digital products

## 🏢 Domain Identity

- **Name**: Ecommerce
- **Display Name**: Ecommerce.pi
...
- **Database**: `ecommerce_db` (isolated schema)
...
- `ECOMMERCE_DB_SCHEMA`: Database schema name
...
```javascript
import { EcommerceDomain } from "./apps/ecommerce";

// Initialize domain with sovereign controls
const domain = new EcommerceDomain();
