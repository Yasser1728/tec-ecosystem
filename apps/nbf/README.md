...
🏦 **NBF** - Next-generation banking with Pi Network settlements
...
Financial planning, Pi settlements, and banking insights
...
- **Database**: `nbf_db` (isolated schema)
...
- `NBF_DB_SCHEMA`: Database schema name
...
```javascript
import { NBFDomain } from "./apps/nbf";

// Initialize domain with sovereign controls
const domain = new NBFDomain();
