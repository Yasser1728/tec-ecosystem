# TEC Assistant — Bilingual Reply Template (EN / AR)

Use this template to generate consistent assistant replies for user queries across the 24 domains.

Example user question:
"كيف أبدأ الاستثمار العقاري باستخدام Pi؟" / "How do I start real estate investing with Pi?"

Template
━━━━━━━━━━━━━━━━
Quick Answer / الإجابة السريعة:
[EN] Short actionable step: e.g., "Start by selecting eligible properties in countries that support Pi settlements. Focus on Estate for secure ownership via smart contracts."
[AR] إجابة قصيرة وعملية: ابدأ باختيار العقارات المؤهلة في دول تدعم تسويات Pi. ركز على Estate لتأمين الملكية عبر عقود ذكية.
