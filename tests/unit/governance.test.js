...
describe('🏛️ TEC Sovereign Governance Map', () => {
  ...
  beforeEach(() => {
    ...
    // ✅ FIXED: Clean up files from previous tests ONLY (not pre-existing files)
  ...
  test('runSovereignTaskMap creates sandbox service and logs ledger', async () => {
    ...
    // ✅ FIXED: Add error handling for JSON.parse
    let ledgerData;
    try {
  ...
  }, 10000); // ✅ FIXED: Add 10 second timeout
  ...
  }, 5000); // ✅ FIXED: Add 5 second timeout
