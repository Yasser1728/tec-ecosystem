...
export class TECAssistantGovernance {
  ...
  async verifySecurityContext(userId, context) {
    try {
      ...
      // Full Zero-Trust is for transactional/financial endpoints
      ...
      // Allow assistant access even if session check fails
      // Advisory queries are low-risk and should be accessible
      return {
        passed: true,
