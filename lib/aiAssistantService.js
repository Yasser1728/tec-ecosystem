...
export function validateFilename(filename) {
  ...
  // Defense-in-depth: Explicit check for path traversal patterns
  // While the regex above already prevents these, this explicit check
  // provides clarity and an additional layer of security
