...
class PaymentAlertLogger {
  ...
  /**
   * Send alert to Sentry (placeholder for actual Sentry SDK integration)
   * In production, this would use @sentry/nextjs
   */
  sendToSentry(alert) {
    try {
      // Placeholder for Sentry integration
      // In production: Sentry.captureEvent({ message: alert.message, level: alert.level, extra: alert.context });
