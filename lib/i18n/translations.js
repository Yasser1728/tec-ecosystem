...
export const translations = {
  en: {
    ...
    nexus: {
      ...
      noMatchingDomains: "No matching domains found. Try using different keywords.",
    },
    ...
    payment: {
      ...
      alternativeMethodsComingSoon: "Alternative payment methods coming soon",
    },
  ...
  ar: {
    ...
    nexus: {
      ...
      noMatchingDomains: "لم يتم العثور على نطاقات مطابقة. حاول استخدام كلمات مختلفة.",
    },
    ...
    payment: {
      ...
      piNetwork: "شبكة Pi",
      alternativeMethodsComingSoon: "سيتم إضافة طرق دفع بديلة قريباً",
    },
