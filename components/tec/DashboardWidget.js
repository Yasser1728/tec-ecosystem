...
export default function DashboardWidget({
  ...
  return (
    <div
      className={`bg-gray-800 p-6 rounded-lg border ${borderColors[color]} hover:border-opacity-50 transition-all duration-300`}
    >
      {isLoading ? (
        ...
        <>
          ...
          <div
            className={`text-3xl font-bold mb-2 bg-gradient-to-r ${colorClasses[color]} bg-clip-text text-transparent`}
          >
            {value}
          </div>
